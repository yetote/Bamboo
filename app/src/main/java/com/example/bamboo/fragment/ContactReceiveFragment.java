...
import com.example.bamboo.adapter.ContactReceiveAdapter;
 ...
 * @class describe
 */
public class ContactReceiveFragment extends Fragment {
    private RecyclerView recyclerView;
    private ArrayList<AddImBean> list;
    private ContactReceiveAdapter adapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_contact_receive, null);
        initView(view);

        MyApplication.retrofit.create(UserService.class)
                .selectAddContactIm(MyApplication.uId, "receive")
    ...
    private void initView(View view) {
        recyclerView = view.findViewById(R.id.contact_receive_rv);
        list = new ArrayList<>();
        adapter = new ContactReceiveAdapter(getActivity(), list);
    }
}
