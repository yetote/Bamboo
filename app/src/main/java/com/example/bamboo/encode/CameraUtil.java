...
public class CameraUtil {
    ...
    public CameraUtil(Context context, int displayWidth, int displayHeight, MutexUtil mutexUtil) {
        this.context = context;
        this.displayWidth = displayWidth;
        this.displayHeight = displayHeight;
        encodeVideo = new EncodeVideo(1280, 640, mutexUtil);
...
//                chooseBestSize(FRONT_CAMERA, bestPreviewSizes);
    ...
    private void encodeData(Image img) {
